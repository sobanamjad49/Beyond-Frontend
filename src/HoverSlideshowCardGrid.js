...
//   const duration = 1500;
//  // ✅ ADD THIS: Preload all images
//  //Agar aap chahte ho ke sab images pehle se load ho jayein (taake cancel na ho), to aap ye code useEffect me daal sakte ho:
//   useEffect(() => {
//     images.forEach((img) => {
...
//       {/* Card container */}
//       <div
//         className="relative group w-full h-full  overflow-hidden border border-gray-200 bg-gray-100"
...
//   opacity-0 sm:opacity-0 md:opacity-0 lg:opacity-0 
//   group-hover:opacity-100 transition-opacity duration-300 z-20"
//         >
//             {/* ADD TO CART Button (always shown on hover) */}
      
//           <Link
//             to={`/productdetails/${_id}`} // assumes price = product._id or slug
