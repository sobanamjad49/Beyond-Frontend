...
function Bags() {
  const { products, loading } = useProducts(); // 🔁 use global product data
  ...
  useEffect(() => {
    ...
    const filtered = products.filter(
      (product) => product.category === "Bagssimages"
    );
  ...
  return (
    <div className="p-4">
      <h2 className="text-center text-4xl font-medium mb-4 uppercase">Bags</h2>
